!(function(win){
    ...
    var importExcelTpl =
        ...
        '</div>'+
        '<p class=\"ouiFile-importing-file\">'+
        '<span class=\"ouiFile-import-status ouiFile-import-success\">成功导入 <span class=\"file-name\">xxx.*</span></span>'+
        '</p>'+
     ...
     * @param options
     */
    oui.showImportFileDialog4Require = function(options){
        ...
        var fileSizeLimit = upDialog.attr('fileSizeLimit')||'1024 MB';
        ...
        oui.setPageParam('data_'+dialogViewId,{
            ...
            dialogViewId:dialogViewId,
            upDialog:upDialog,
            uploadURL: upDialog.attr('uploadURL') || oui.uploadURL,
