    ...
    function (Evented,
        ...
        return declare([InfoWindowBase, Evented], {
            ...
            show: function (location) {
                ...
                var $infoWindow = $(this.domNode);
                var infoHeight = $infoWindow.outerHeight(true);
                var infoWidth = $infoWindow.outerWidth(true);

                //Position 10x10 pixels away from the specified location
                var left = location.x - infoWidth / 2;
                var top = location.y - infoHeight - 48;
            ...
            destroy: function () {
                ...
                this._closeButton = this._content = null;
