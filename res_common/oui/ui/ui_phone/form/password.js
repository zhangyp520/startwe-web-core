(function(win){
	...
	Password.templateHtml[0] ='<input id="{{id}}" onfocus="oui.hideErrorInfo(this);" validate="{{validate}}" style="{{fieldStyle}}" class="oui-form" name="{{name}}" type="password" value="{{value}}" {{=commonEvent}} />' ;
	/***********************************控件事件***********************************/
