	...
	H.prototype.config = {
		...
		u.on("mousemove", function(e) {
			var i = t(this),
				a = i.offset().left,
				l = e.clientX - a;
//			console.log(c.allowResize)
			i.attr("colspan") > 1 || i.attr("unresize") || c.resizeStart || (c.allowResize = i.width() - l <= 10, o.css("cursor", c.allowResize ? " " : ""))
		}).on("mouseleave", function() {
			t(this);
...
//				})
		...
		}), u.find('div').on("click", function() {
			var i, l = t(this).parent(),
				n = l.find(C),
				o = n.attr("lay-sort");
