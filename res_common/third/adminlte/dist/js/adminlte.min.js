...
+function (a) {
    ...
    }, a(document).on("click", e.data, function (e,c) {
        e.stopPropagation()
    ...
    h.prototype.init = function () {
        ...
        if($(".treeview a.active ").offset()!==undefined){
            $('.childrenBar').css({'top': $(".treeview ").find('a.active').offset().top-10+'px'});
        }
    }, h.prototype.close = function () {
        if($(".treeview a.active").offset()!==undefined) {
            $('.childrenBar').css({'top': $(".treeview ").find('a.active').parents('ul').prev('a').offset().top + 'px'});
        }
