!(function(win, $) {
  var newData = {
    bizId: "",
    content:
      '\n        <div class="page-abs page-abs-printForm paper-area A4 bg-center"\n            style="width:210mm;height:297mm;;{{if pageData.getDesigner()&&pageData.getDesigner().backgroundImage}}background-image:url({{=pageData.getDesigner().backgroundImage}}){{/if}};">\n            \n\n             \n            <div id="ctrl_661164395073566320"\n            class="control-abs control-abs-component control-abs-html-container control-abs-textfield {{pageData.getControl&&pageData.getControl(\'ctrl_661164395073566320\').style.cls}} control-abs-hideTitle "\n            style="left:0px;top:312px;z-index:2;opacity:1;width:793px;height:60px;border-radius:0px;border-left-width:0px;border-top-width:0px;border-right-width:0px;border-bottom-width:0px;border-left-color:#e6e6e6;border-top-color:#e6e6e6;border-bottom-color:#e6e6e6;border-right-color:#e6e6e6;border-left-style:solid;border-top-style:solid;border-bottom-style:solid;border-right-style:solid">\n            <div class="control-inner-abs" style="left:px;top:px;z-index:;opacity:1;vertical-align:middle">\n                \n        \n\n        \n        <div class="control-title-abs" style="left:px;top:px;z-index:;opacity:1;line-height:1.6;font-size:14px;vertical-align:middle;color:#333333;font-weight:normal;text-align:right;white-space:normal">通用容器\n        </div>\n        <div class="control-container-abs" style="left:px;top:px;z-index:;opacity:1">\n            <oui-include url="{{pageData.findControlUrl(\'ctrl_661164395073566320\')}}"\n                     ref="ctrl_661164395073566320"\n                     type="module"\n                     data="__data().data.pageData.getControlRenderDataById(\'ctrl_661164395073566320\')"></oui-include>\n        </div>\n        \n        \n        \n            </div>\n        </div>   \n            <div id="ctrl_014150990527507239"\n            class="control-abs control-abs-component control-abs-html-container control-abs-button {{pageData.getControl&&pageData.getControl(\'ctrl_014150990527507239\').style.cls}} control-abs-hideTitle "\n            style="left:0px;top:397px;z-index:3;opacity:1;width:793px;height:60px;border-radius:0px;border-left-width:0px;border-top-width:0px;border-right-width:0px;border-bottom-width:0px;border-left-color:#e6e6e6;border-top-color:#e6e6e6;border-bottom-color:#e6e6e6;border-right-color:#e6e6e6;border-left-style:solid;border-top-style:solid;border-bottom-style:solid;border-right-style:solid">\n            <div class="control-inner-abs" style="left:px;top:px;z-index:;opacity:1;vertical-align:middle">\n                \n        \n\n        \n        <div class="control-title-abs" style="left:px;top:px;z-index:;opacity:1;line-height:1.6;font-size:14px;vertical-align:middle;color:#333333;font-weight:normal;text-align:right;white-space:normal">按钮组件\n        </div>\n        <div class="control-container-abs" style="left:px;top:px;z-index:;opacity:1;text-align:center">\n            <oui-include url="{{pageData.findControlUrl(\'ctrl_014150990527507239\')}}"\n                     ref="ctrl_014150990527507239"\n                     type="module"\n                     data="__data().data.pageData.getControlRenderDataById(\'ctrl_014150990527507239\')"></oui-include>\n        </div>\n        \n        \n        \n            </div>\n        </div>  \n        </div>\n    ',
    controls: [],
    createTime: "2021-10-20 15:18:35",
    creatorId: "507393861941723136",
    creatorName: "用户_f2b15ec7bafb4b0ba902c27ac316c252",
    delFlag: 1,
    description: "",
    enName: "",
    events: {},
    extraAttrs: {
      removeProjectListTemplateUrl:
        "/QjYfAj.biz?id=570857939737247744&o_as=10ff1c93234c9e99c948b4cfab7ae801f40344a5",
    },
    id: "570857939737247744",
    innerStyle: {
      styleInnerOuter: {
    ...
    listContent:
      '<div class="toolbar">\n            <div class="header" style="display: inline-block;">\n                <div class="button-wrap" style="float: left">\n                    <button oui-e-click="event2new" menu-id="570857939737247744" new-save-url="{{logic4new}}" type="button" class="btn">\n                        <span>新增</span>\n                    </button>\n                    <button oui-e-click="event2edit" menu-id="570857939737247744" type="button" class="btn">\n                        <span>编辑</span>\n                    </button>\n                    <button oui-e-click="event2remove" menu-id="570857939737247744"  type="button" class="btn">\n                        <span>删除</span>\n                    </button>\n                </div>\n                <div class="search" style="float: right">\n                    <oui-condition id="simple-search-condition"\n                                   searchTitle="根据输入条件，在当前表格数据中检索"\n                                   showType="10" type="condition" callback="com.startwe.models.page.web.PageRuntime.searchCallback"\n                                   cancelback="com.startwe.models.page.web.PageRuntime.searchCancelback">\n\n                        \n                        \n                        <oui-field title="通用容器" placeholder="请输入-通用容器" showType="0" dataType="STRING"\n                                   opt="like" controlType="textfield" name="ctrl_612893874479722446"></oui-field>\n\n                        \n                        \n                        \n                        <oui-field title="按钮组件" placeholder="请输入-按钮组件" showType="0" dataType="STRING"\n                                   opt="like" controlType="button" name="ctrl_639104016330232743"></oui-field>\n\n                        \n                        \n\n                    </oui-condition>\n                </div>\n            </div>\n        </div>\n        <div class="table-details">\n            <oui-table id="list-570857939737247744"\n                       type="tablegrid"\n                       showHLines="false"\n                       style="height: 100%"\n                       allowColumnResize="true"\n                       allowAlternating="true"\n                       multiSelect="true"\n                       onCelldblclick=""\n                       onAfterLoad=""\n                       onCellClick=""\n                       lockColumnSize="2"\n                       showHeaderLines="false"\n                       showColumnsMenu="false"\n                       dataUrl="{{logic4query}}"\n                       emptyTips="暂无数据">\n                <oui-columns>\n                    <oui-column-checkbox width="40" headerAlign="center" align="center"></oui-column-checkbox>\n                    <oui-column fieldName="id"  hideable4menu="true" visible="false"></oui-column>\n                    <oui-column fieldName="eid"  hideable4menu="true" visible="false"></oui-column>\n\n                    \n                    \n                    <oui-column allowSort="true" width="120" fieldName="ctrl_612893874479722446" align="left" headerAlign="left">通用容器</oui-column>\n                    \n                    \n                    \n                    <oui-column allowSort="true" width="120" fieldName="ctrl_639104016330232743" align="left" headerAlign="left">按钮组件</oui-column>\n                    \n                    \n                </oui-columns>\n                <oui-pager id="oui-pager" type="pager" showPageNumSize="10" pageIndex="1" pageSize="10" total="1" class="oui-class-pager text-right"></oui-pager>\n            </oui-table>\n        </div>',
    modelType: 1,
    modifiedId: "507393861941723136",
    modifiedName: "用户_f2b15ec7bafb4b0ba902c27ac316c252",
    modifyTime: "2021-10-20 15:18:35",
    name: "页面名称",
    orgId: "",
    orgName: "",
    otherAttrs: {
    ...
    pageId: "335225902589927010",
    projectId: "562924577571733504",
    state: 1,
    style: {
      height4px: 1122.52,
      backgroundColor: "",
  ...
  /***     <option value="printForm" {{if AbsoluteDesign.data.pageDesignType=='print'}}selected="selected"{{/if}}>表单打印设计器</option>
     ...
     ***/
  var PageDesignTypeEnum = com.oui.pagedesign.PageDesignTypeEnum;
  ...
  var AbsoluteDesign = {
      ...
      oui.loadApiConfig(
        ...
        function() {
          ...
          me.initByUrlParams(function() {
            ...
            me.data = data || newData ;

            var url = param.queryPageViewsByProjectIdUrl;

          
            console.info(param,'paramparamparam')
            oui.postData(
              url,
              {
                pageId: param.pageId,
              ...
              function(res) {
                console.info(res.pageViews,'newData')
                if (res.pageViews.length == 0) {
                  me.data = newData ;
                } else {
                  me.data = res.pageViews[Number(param.num)];
                  console.log(res.pageViews, param.num, "12");
                }
                ...
                me.data.style.height = 210;
                me.data.style.width = 250;
                me.transPage4Front(me.data);

                console.log(me.data, "页面数据");
                me.loadPageQueryTemplatesUrl =
                  me.data.extraAttrs.loadPageQueryTemplatesUrl;
                me.updateProjectPortalUrl =
                  me.data.extraAttrs.updateProjectPortalUrl;
                me.init4parse(); 
    ...
    initByUrlParams: function(callback) {
      ...
      var pageDesignType =
        page.pageDesignType ||
        paramCfg.pageDesignType ||
        param.pageDesignType ||
        "printForm";

      var designTplUrl =
        oui.getContextPath() +
        "res_engine/page_design/common/runtime/page-design-form-tpl.html";

      // if(param.pageDesignType =='listForm'){
      //     //纯div占位 模板http://localhost/res_engine/page_design/common/runtime/page-design-form-tpl.html?isHtml=true&_=1634695902543

      //     designTplUrl = oui.getContextPath()+'res_engine/page_design/common/page-design-tpl-space.html';
      // }
      ...
      //L.T添加
      paramCfg.bizJs=['/res_apps/project/js/page-design/page-design-plugin.js']
    ...
    // isShowValidateControlProps:function(){
    //     var me = this;
    //     var state = me.state;
    //     var flag = false;
    ...
    initBefore: function() {
      ...
      if (!params.controlBizPropsUrl) {
        ...
        params.controlBizPropsUrl =
          "res_engine/page_list_design/pc/components-biz-prop-art-tpl";
      }
    ...
    event2setCurrTab2BProps: function(cfg) {
      var me = this;
      me.activeTab = 2;
      if (oui.browser.ie) {
        me.changePropsView();
    ...
    changed4propsRealTime: function(cfg, callback) {
      console.log("res_engine\page_list_design\pc\js\page_list_design.js")
      var me = this;
    ...
    event2save: function() {
      ...
      console.info(me.paramCfg,'me.paramCfg')
    ...
    findCallbackByName: function(name) {
      ...
      callbackMethods = {saveCallbackMethod: "saveCallBack" }
    ...
    findCurrentPropslUrl() {
      ...
      if (
        ...
        //组件属性面板地址
        return (
          "res_engine/page_list_design/pc/components-biz-prop-tpl/" +
          currentControldata.controlType +
          ".vue.html"
        );
      } else {
        return "res_engine/page_list_design/pc/components-biz-prop-tpl/search_codition_designer.vue.html";
      }
    },
  };
