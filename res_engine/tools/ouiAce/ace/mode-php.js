...
var PhpLangHighlightRules = function() {
    ...
    var builtinFunctions = lang.arrayToMap(
        ...
        'stats_page_deviation|stats_cdf_beta|stats_cdf_binomial|stats_cdf_cauchy|stats_cdf_chisquare|stats_cdf_exponential|stats_cdf_f|' +
...
var functionMap = {
    ...
    "apache_request_sub_req_lookup_file": [
        ...
        "Returns sub-request for the specified file.  You would     need to run it youielf with run()."
    ],
    "apache_request_sub_req_lookup_uri": [
        "object apache_request_sub_req_lookup_uri(string uri)",
        "Returns sub-request for the specified uri.  You would     need to run it youielf with run()"
    ],
    ...
    "imagetruecolortopalette": [
        ...
        "Convert a true colour image to a palette based image with a number of coloui, optionally using dithering."
    ],
    "imagettfbbox": [
...
var XmlBehaviour = function () {
    ...
    this.add("string_dquotes", "insertion", function (state, action, editor, session, text) {
        if (text == '"' || text == "'") {
            ...
            if (selected !== "" && selected !== "'" && selected != '"' && editor.getWrapBehaviouiEnabled()) {
                return {
