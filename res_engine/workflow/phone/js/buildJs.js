	...
	function getContextPath(){
		...
		if(window.oui_context && window.oui_context.contextPath){
			return window.oui_context.contextPath
		}
		...
		if(typeof window.oui_context =='undefined'){
			window.oui_context = {contextPath:''};
		}
		window.oui_context.contextPath = result;
		return result;
	}
